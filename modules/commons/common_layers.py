...
# ═══════════════════════════════════════════════════════════════════════
# SSM Compatibility Aliases
# Replaces Transformer components with Mamba-based SSM equivalents.
# Importing EncSALayer or TransformerFFNLayer now gets BiMambaBlock and
# GatedMambaFFN respectively, preserving full backward compatibility.
# ═══════════════════════════════════════════════════════════════════════

from modules.commons.ssm_layers import BiMambaBlock, GatedMambaFFN

# Backward-compatible aliases
EncSALayer = BiMambaBlock
TransformerFFNLayer = GatedMambaFFN
